...
public class FabricFluidPipeWrapper implements Storage<FluidVariant>, StorageView<FluidVariant> {
    ...
    public long insert(FluidVariant fluidVariant, long maxAmount, TransactionContext transaction) {
        FluidWithData fluid = new FluidWithData(fluidVariant.getFluid(), fluidVariant.getComponentsPatch());
    ...
    public FluidVariant getResource() {
        return this.pipe.isEmpty() ? FluidVariant.blank() : FluidVariant.of(this.pipe.getFluid().getFluid(), this.pipe.getFluid().getComponents());
    }
